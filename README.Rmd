...
by Eric C. J. Oliver that can be found on [GitHub](https://github.com/ecjoliver/marineHeatWaves). This package is actively maintained, but it has been forked to a new package called [heatwaveR](https://robwschlegel.github.io/heatwaveR/index.html), which will supercede and replace RmarineHeatWaves in the near future (for continuity, we are ensuring that the functionality here will be exactly the same in heatwaveR). 
