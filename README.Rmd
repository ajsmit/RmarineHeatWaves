...
[![AppVeyor Build Status](https://ci.appveyor.com/api/projects/status/github/ajsmit/RmarineHeatWaves?branch=master&svg=true)](https://ci.appveyor.com/project/ajsmit/RmarineHeatWaves)
...
```{r detect-example, fig.height = 3, fig.width = 8, message = FALSE, warning = FALSE}
...
```{r fig-example, fig.height = 3, fig.width = 8}
