...
If one requires more control over the output, one may choose to create these figures in ggplot2 as geoms:

```{r fig-example1, fig.height = 3, fig.width = 8}
ggplot() + geom_event_line(mhw, spread = 200, metric = "int_cum",
           start_date = "2011-01-01", end_date = "2011-08-30") +
  geom_text(aes(x = as.Date("2011-06-01"), y = 28, label = "The MHW that launched\na thousand papers."))
ggplot() + geom_lolli_plot(mhw) +
  geom_text(aes(x = as.Date("2007-01-01"), y = 5, 
...
```{r fig-example2, fig.height = 3, fig.width = 8}
ggplot() + geom_event_line(mcs, spread = 200, metric = "int_cum",
           start_date = "1990-01-01", end_date = "1990-08-30")
ggplot() + geom_lolli_plot(mcs)
```
