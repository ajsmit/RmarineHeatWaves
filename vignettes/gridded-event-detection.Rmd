...
knitr::opts_chunk$set(fig.width = 3.5, fig.path = '/man/figures', fig.align = 'center',
                      echo = FALSE, warning = FALSE, message = FALSE, tidy = FALSE)
```
...
The above code produces a plot of 0.25 degree Reynold's OISST around South Africa showing especially the increase in frequency of marine heat waves (trend per decade) within the Agulhas Current:

<center>
<img src="the-figure-1.png" width="45%">
\center

<!-- ![**Figure 1.** Plot of 0.25 degree Reynold's OISST around South Africa showing especially the increase in frequency of marine heat waves (trend per decade) within the Agulhas Current.](/Users/ajsmit/Dropbox/repos/packages/RmarineHeatWaves/vignettes/Figs/the-figure-1.png) -->
