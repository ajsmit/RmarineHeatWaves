...
#' above, switch the values being fed to the \code{y} and \code{thresh} 
...
#'   geom_flame(aes(thresh = thresh_clim_year)) +
...
GeomFlame <- ggplot2::ggproto("GeomFlame", ggplot2::Geom,
                              ...
                              default_aes = aes(colour = NA, fill = "salmon",
                              ...
                              draw_group = function(data, panel_scales, coord, na.rm = FALSE) {
                                ...
                                data$thresh[is.na(data$thresh)] <- data$y[is.na(data$thresh)]
                                
                                # Remove missing values for better plotting
                                data$y[data$y < data$thresh] <- NA
